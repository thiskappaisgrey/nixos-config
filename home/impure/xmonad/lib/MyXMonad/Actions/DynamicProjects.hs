-- Copied Module from xmonad-contrib, since the one in the lib doesn't expose internal data-structures
-- TODO Expose internal data-structures to use with external prompts (rofi)
...
module MyXMonad.Actions.DynamicProjects
       ( -- * Overview
         -- $overview
